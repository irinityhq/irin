...
printf 'Private phone access: controlled in installed IRIN.app Settings (not by make setup); open the served URL in a browser on the same tailnet.\n'
...
printf 'Desktop product: signed DMG (IRIN.app); source browser path: make warroom\n'
