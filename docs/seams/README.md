...
Short **change-class** checklists for implementers and coding agents. These are
...
Related but thinner for this set: sequence-watch config changes live under
